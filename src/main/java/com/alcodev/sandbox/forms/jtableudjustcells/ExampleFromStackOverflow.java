 ...
 * Time: 9:51 AM
 */
public class ExampleFromStackOverflow extends JPanel {
    private JTable mainTable;

    public ExampleFromStackOverflow() {
    ...
    private static void createAndShowGUI() {
        ...
        ExampleFromStackOverflow newContentPane = new ExampleFromStackOverflow();
